...
<head>
    ...
    <title>Health Care Provider Page</title>
    <style type="text/css">
        ui{
            line-height: 30px;
        }
...
<div data-options="region:'north',split:true" style="height:95px;">
    <div style="margin: 30px 50px;" >
        <h2 style="font-size:30px;font-weight: bolder;color:#a2a2a2">Health Care Provider Homepage</h2>
    </div>
    <div style="position:absolute; left: 35%;top: 10px">
        <p  style="font-family: MyNewFont"><font color="#4ac9ff" size="7px">COVID-19 Booking </font><font size="7px" color="#ff508b">System</font><font color="#" size="4px">&nbsp;Group SDA8</font></p>
    </div>
...
<div data-options="region:'west',title:'system menu',split:true" style="width:200px;">
    <div id="aa" class="easyui-accordion" style="width:193px" data-options="multiple:true,border:0">
        <div title="Add New" data-options="iconCls:'icon-edit'" style="overflow:auto;padding:10px;">
            <ui>
                <li><a href="javascript:void(0);" pageUrl="add_timeslot" >Add new time slot</a></li>
            </ui>
        </div>

        <div title="View" data-options="iconCls:'icon-search'" style="padding:10px;">
            <ui>
                <li><a href="javascript:void(0);" pageUrl="get_timeslot">See all time slots</a></li>
                <li><a href="javascript:void(0);" pageUrl="get_user"  >See all users</a></li>
            </ui>
        </div>
...
<div data-options="region:'center',title:'content'" style="padding:5px;background:#eee;">
    <div id="tt" class="easyui-tabs"  data-options="fit:true">
        <div title="welcome page" style="padding:20px;display:none;">
            ...
            You're logged in as a Health Care Provider, you can create or view timeslots
        </div>
    </div>
</div>
</body>
